...
const references = [
  ...
  `"Effect of Oral L-Arginine Supplementation on Blood Flow and Circulatory Health" – Chen J, et al. (Journal of Nutrition, 1999)`,
  ...
  `"Standardised Water-Soluble Extract of Eurycoma longifolia (Tongkat Ali) and Its Effect on Energy and Vitality in Adult Men" – Tambi MI, et al. (Phytotherapy Research, 2012)`,
  ...
  `"Effect of Lepidium meyenii (Maca) on Energy and General Wellbeing in Healthy Adults" – Gonzales GF, et al. (Journal of Ethnopharmacology, 2002)`,
  `"Maca Root Extract and Its Influence on Energy and Physical Endurance" – Stone M, et al. (Journal of Ethnopharmacology, 2009)`,
  `"A Randomized, Double-Blind, Placebo-Controlled Study of an Ashwagandha Extract on Stress and Overall Wellbeing in Adults" – Lopresti AL, et al. (Medicine, 2019)`,
  ...
  `"Icariin, a Key Compound in Horny Goat Weed (Epimedium spp.), and Its Antioxidant Properties" – Shindel AW, et al. (Journal of Ethnopharmacology, 2010)`,
  `"Icariin and Its Effects on Circulatory Health" – Xin ZC, et al. (Journal of Natural Products, 2003)`,
  `"Dietary Nitrate from Beetroot and Its Effect on Blood Flow and Vascular Function" – Webb AJ, et al. (Hypertension, 2008)`,
  `"Beetroot Juice Supplementation and Exercise Endurance" – Jones AM (Sports Medicine, 2014)`,
